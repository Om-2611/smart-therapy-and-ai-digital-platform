    ...
    <div style={{ flexShrink: 0, position: 'relative' }}>
      ...
      >
        ...
        <div style={{ flexShrink: 0 }}>
          ...
          <div style={{ fontSize: 9, color: RC.inkMuted, marginTop: 2, paddingLeft: 2 }}>
        ...
        <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', gap: 8 }}>
          <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontSize: 11, fontWeight: 600, color: RC.ink, marginTop: 1 }}>
              {dateLabel} · {timeLabel}
            </div>
            <div style={{ fontSize: 10, color: RC.inkMuted }}>{sessionType}</div>
          </div>
          <button
        ...
        >
          {[
            ...
            <div key={k} style={{ display: 'flex', justifyContent: 'space-between', gap: 12, padding: '4px 0' }}>
              <span style={{ fontSize: 10, color: RC.inkMuted }}>{k}</span>
              <span
                style={{
                  fontSize: 10,
                  fontWeight: 600,
